                ...
                if (
                    ...
                    setQuestions((prevQuestions) =>
                        prevQuestions.map((question) =>
                            question.$id !== res.payload.$id ? question : res.payload
                        )
                    );
                }
            }
            ...
            {isModalOpen && (
                <div className="modal-overlay" onClick={() => setIsModalOpen(false)}>
                    <div className="modal-content">
                        <img src="https://www.dkayu.fr/wp-content/uploads/2025/01/Rapport-Map.png" alt="Carte" />
                    </div>
                </div>
            )}
        </div>
